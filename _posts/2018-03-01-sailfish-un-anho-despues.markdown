...
Necesito mencionar también que la aplicación de música es controlable desde la pantalla de bloqueo, pero he aquí otro problema. Veamos, usted desbloquea la pantalla para cambiar de música y empieza a buscar entre las canciones. Digamos, por otro lado que usted ha configurado el teléfono para bloquearse automáticamente después de 30 segundos. Si en medio de su búsqueda de música en la pantalla de bloqueo se completan los 30 segundos el teléfono sin más, se bloquea. Sin importar que aún está utilizándose la interfaz.
